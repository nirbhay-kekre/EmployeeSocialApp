...
public interface ICollaborationAPI {
	...
	ResponseEntity<CollaboratorMessage> addCollaborator(@PathVariable(value = "id1", required = true) Long id1,
	...
	ResponseEntity<CollaboratorMessage> removeCollaborator(@PathVariable(value = "id1", required = true) Long id1,
			@PathVariable(value = "id2", required = true) Long id2,
			@RequestParam(value = "format", defaultValue = "json", required = false) String format);
}
